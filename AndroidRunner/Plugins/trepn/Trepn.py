...
class Trepn(Profiler):
    ...
    def collect_results(self, device):
        ...
        if newest_db:
            ...
            util.wait_until(self.file_exists_and_not_empty, 25, 1, device, Trepn.DEVICE_PATH, csv_filename)
            ...
            # device to the host.
            util.wait_until(os.path.exists, 25, 1, op.join(self.output_dir, csv_filename))
