...
time_filename="/home/pi/Green-lab-android-runner/mitmproxy_response.csv"
interface = 'wlan0'
...
packet_filename = "/home/pi/Green-lab-android-runner/packet_capture.csv"
interface = 'wlan0'
...
class Sx5NetworkPacketsCalculator:
    ...
    def start_packet_capture(self, interface):
        try:
            ...
            self.packet_capture_thread = threading.Thread(target=self.packet_capture.start_execution, daemon=True, name='Background')
            ...
            print(e)
            print("Error encountered during the packet capture in our process!")
